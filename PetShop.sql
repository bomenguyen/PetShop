...
(
	...
	CONSTRAINT FK_THONGTIN_PET_PHANLOAI FOREIGN KEY (MaPL) REFERENCES PHANLOAI(MaPL),
	CONSTRAINT FK_THONGTIN_PET_NCC FOREIGN KEY (MaNCC) REFERENCES NCC(MaNCC)
)
go
...
(
	...
	DienthoaiKH Varchar(50) NOT NULL primary key,
...
(
	...
	Ngaydat varchar(50),
	Thanhtoan nvarchar(50),-- 1 đã thanh toán, 0 chưa THANH toán
	CONSTRAINT PK_DON_DAT_HANG PRIMARY KEY (MaDH),
	CONSTRAINT FK_DON_DAT_HANG_KHACHHANG FOREIGN KEY (DienthoaiKH) REFERENCES KHACHHANG(DienthoaiKH),
...
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
	VALUES('AO1', 1, N'CHÓ ALASKA Drey', N'Tên: Drey
										...
										Sổ sức khỏe: có
										Tiêm vacxin: 2 mũi
										Tẩy giun: lần 1.', '19000000', 'A02', 'NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
	VALUES('AO2', 1, N'CHÓ ALASKA Anita', N'Tên: Anita
										...
										Sổ sức khỏe: có
										Tiêm vacxin: 2 mũi
										Tẩy giun: lần 1.', '12000000', 'A03','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
	VALUES('AO3', 1, N'CHÓ ALASKA Selena', N'Tên: Selena
										...
										Sổ sức khỏe: có
										Tiêm vacxin: 2 mũi
										Tẩy giun: lần 1.', '10000000', 'A04', 'NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '11000000', 'A05', 'NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '16000000', 'A06', 'NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '20000000', 'A07','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '15000000' , 'A08', 'NC1')	
	/********** husky ************/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH,MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '8000000', 'H01', 'NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 1 mũi
Tẩy giun: lần 1.', '9000000', 'H02', 'NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '7000000', 'H03','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 1 mũi
Tẩy giun: lần 1.', '7000000', 'H04','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Tình trạng: có sẵn.
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi', '7000000', 'H05','NC1')
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '15000000', 'S01','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '20000000', 'S02','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '7000000', 'S03','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '7000000', 'S04','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '30000000', 'S05','NC2')

	/********** PHỐC SÓC ************/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
	VALUES('DO1', 4, N'CHÓ PHỐC SÓC THÁI LAN – STELLA', N' Stella 2,5 tháng tuổi thuộc giống Chó Pomeranian Khỏe mạnh, đã được tẩy giun và tiêm 2 mũi vaccine phòng bệnh cho bé trước khi đến tay chủ mới.', '8000000', 'P01','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '9500000', 'P02','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', 20000000, 'P03', 'NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '9000000', 'P04','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Tẩy giun: đã tẩy giun','8500000', 'P05','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Thanh toán: tiền mặt hoặc trả góp lãi suất 0%
Vaccine: đã tiêm phòng 2 mũi vaccine
Tẩy giun: đã tẩy giun', '13000000', 'P06','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
	VALUES('DO7', 4, N'CHÓ PHỐC SÓC Yona', N'Yona cái 2,5 tháng tuổi, thuộc giống Pomeranian. Khỏe mạnh, đã được tẩy giun và tiêm 2 mũi vaccine phòng bệnh cho bé trước khi đến tay chủ mới.', 11500000, 'P07','NC2')
	/********** NGAO Ý ************/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '25000000' , 'N01','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
	VALUES('EO2', 5, N'CHÓ NGAO Ý Isla ', N'Isla cái 6 tháng tuổi thuộc giống Cane corso – Ngao ý  Khỏe mạnh, đã được tẩy giun và tiêm 2 mũi vaccine phòng bệnh cho bé trước khi đến tay chủ mới.', '45000000' , 'N02', 'NC1')
	/**********  Poodle ************/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '5000000', 'E01','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '5000000', 'E02','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '6000000', 'E03','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '7000000', 'E04','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '8000000', 'E05','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1','9000000', 'E06','NC2')
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '6000000', 'B01','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '6000000', 'B02','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '9000000', 'B03','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '9000000', 'B04','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1', '9000000', 'B05','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1','8000000', 'B06','NC2')
	/*********** Mèo Munchkin **********/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1. ', '18000000', 'M01','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1. ', '11000000', 'M02','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1. ', '16000000', 'M03','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1. ', '12000000', 'M04','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1. ', '20000000', 'M05','NC2')
	/*********** Mèo Bengal **********/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '10000000', 'C01','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '1000000', 'C02','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '20000000', 'C03','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '20000000', 'C04','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '7000000', 'C05','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Sổ sức khỏe: có
Tiêm vacxin: 2 mũi
Tẩy giun: lần 1.', '20000000', 'C06','NC1')
	/*********** Mèo RAGROLL **********/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Tẩy giun: đã tẩy giun', '10000000', 'R01','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
...
Thanh toán: tiền mặt hoặc trả góp lãi suất 0%
Vaccine: đã tiêm phòng 1 mũi vaccine
Tẩy giun: đã tẩy giun', '1000000', 'R02','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
	VALUES('KO3', 10, N'MÈO Ragroll BOB ', N'Bob đực 1 tháng tuổi thuộc giống mèo Ragdoll. Khỏe mạnh, đã được tẩy giun và tiêm 1 mũi vaccine phòng bệnh cho bé trước khi về nhà mới', '20000000', 'R03','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC)
	VALUES('KO4', 10, N'MÈO Ragroll LINA', N'Lina cái 5 tháng tuổi thuộc giống mèo Ragdoll. Khỏe mạnh, đã được tẩy giun và tiêm 1 mũi vaccine phòng bệnh cho bé trước khi về nhà mới', '20000000', 'R04','NC3')
...
Ngoài ra túi xách thú cưng với thiết kế hình ống như một cái hang, tạo cảm giác an toàn cho thú cưng của bạn.','190000','AB1','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
...
Cũng vì thế, trên thị trường bán chuồng lồng nuôi nhốt chó hiện nay có rất nhiều loại chuồng chó với đủ mọi kích cỡ, màu sắc và chất liệu khác nhau. Điều này mang đến cho các chủ nuôi chó nhiều lựa chọn nhưng cũng đôi khi khiến họ đau đầu không biết nên chọn loại chuồng nào.','593000','AB2', 'NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
...
Kích thước: 81 x 56 x 58','2500000','AB3','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
...
Balo thiết kế 2 quai mang chắc, tiện sử dụng trong việc vận chuyển thú cưng.','410000','AB4','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('A016',11,N'Petstar – Túi vận chuyển cao su 42*28*30cm',N'','350000','AB5','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('A017',11,N'Petstar – Túi vận chuyển cao su 32*20*22cm',N'','2500000','AB6','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
...
Giúp thú cưng cảm thấy thoải mái, không bị kích ứng da.','653000','AB7','NC2')

			/*************DỤNG CỤ VỆ SINH.*************/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('B011',12,N'Khay vệ sinh loại lớn',N'','320000','BA1','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
...
Cải thiện tình trạng viêm da, sưng tấy, nhiễm trùng do ve rận','190000','BA2','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('B013',12,N'Cát vệ sinh cho mèo TRIXIE Silikatstreu 5kg',N'','150000','BA3','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('B014',12,N'Cát thủy tinh cho mèo Sanicat Silica Diamonds Lavender',N'','411000','BA4','NC2')

			/*************ĐỒ DÙNG.*************/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('C011',13,N'Bàn cào móng mèo D4',N'','250000','CB1','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('C012',13,N'Ferplast Ergofluo – Yếm size 2 (xanh biển)',N'','250000','CB2','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('C013',13,N'Mũ cho chó mèo AMBABY PET 1JXS071',N'','150000','CB3','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('C014',13,N'Quần áo cho chó mèo AMBABY PET 2JXF139',N'','250000','CB4','NC1')
		
		/*************THỨC ĂN.*************/
				/*************THỨC ĂN. CHÓ*************/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('D011',14,N'Xương cho chó vị thịt bò Vegebrand Meat Beef Bone Large',N'','150000','DB1','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('D012',14,N'Thức ăn cho chó Morando Miglior Cane Preferiti Adult',N'','350000','DB2','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
...
Thức ăn cho chó Fitmin Mini Performance với công thức chế biến riêng biệt. Nhằm đảm bảo chất lượng cho các thú cưng khi sử dụng. Chiết xuất từ cây hương thảo hỗ trợ chức năng gan và sự tiêu hóa được dễ dàng. Đặc biệt thành phần từ cây ngọc giá làm giảm mùi hôi của phân. Dễ dàng cho người nuôi thú vệ sinh. Hàm lượng thịt và trứng gà cao hỗ trợ sự phát triển về thể chất vật nuôi. Ngoài ra những đặc điểm về sản phẩm các bạn có thể tham khảo chi tiết trên bao bì mỗi sản phẩm.','234000','DB3','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('D014',14,N'Thức ăn cho chó Morando Miglior Cane Professional Puppy',N'','630000','DB4','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
...
Thức ăn hạt cho chó Royal Canin Bichon Frise được chế biến theo công thức cực tốt cho da, lông và phòng bệnh sỏi thận ở chó. Giúp những bé Bichon duy trì được sự cân bằng dinh dưỡng và lông chắc khỏe, đẹp hơn. PINCH hợp chất dưỡng da cho chó: Giúp chó có làn da khỏe mạnh, lông không rụng và màu sáng. OMEGA-6: Giúp kích thích làn da tiết chất giữ ẩm, làm mềm và mượt lông.','250000','DB4', 'NC3')
				/*************THỨC ĂN. CHÓ*************/
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('E011',15,N'Thức ăn cho mèo Earthborn Holistic Wild Sea Catch 2.27kg',N'','550000','EA1','NC1')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('E012',15,N'Thức ăn cho mèo Pro Pac Ultimates Savanna Pride Indoor Formula 2kg',N'','365000','EA2','NC2')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('E013',15,N'Thức ăn cho mèo MEC Wild Taste Limited Ingredient 2kg',N'','435000','EA3','NC3')
INSERT INTO  THONGTIN_PET(MaP, MaDM, TenP, MoTa, Giaban, ANH, MaNCC) 
	VALUES('E014',15,N'Sữa bột Dr.Kyan Precaten cho mèo 400g (hộp sắt)',N'','156000','EA4','NC1')
GO

/************ TUYỆT ĐỐI KO ĐC XÓA UPDATE NÀY ĐI ************/
Update THONGTIN_PET
Set MaPL= 3
where MaDM between 11 and 15

Update THONGTIN_PET
Set MaPL= 2
where MaDM between 7 and 10

Update THONGTIN_PET
Set MaPL= 1
where MaDM between 1 and 6


/**********KHACHHANG********/

INSERT INTO KHACHHANG( HoTen,DiachiKH, DienthoaiKH,  Email)
	VALUES ( N'Lê Doanh Doanh', N'2Bis Hùng Vương', N'07077865',  N'')
go
 ...
 /********ĐƠN DẶT HÀNG********/
 INSERT INTO DON_DAT_HANG ( MaDH, DienthoaiKH, Ngaydat, ThanhToan)
	VALUES ('DH1', N'07077865', '11/20/2019',  N'0')
GO
	/******** CT_ĐƠN DẶT HÀNG********/
INSERT INTO CT_DAT_HANG (MaDH, MaP, SoLuong, DonGia)
	values('DH1', 'AO3',1, '9000000' )
INSERT INTO CT_DAT_HANG (MaDH, MaP, SoLuong, DonGia)
	values('DH1', 'B013',1, '1000000' )
INSERT INTO CT_DAT_HANG (MaDH, MaP, SoLuong, DonGia)
	values('DH1', 'D011',1, '500000' )
GO
