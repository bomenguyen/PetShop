...
namespace Petshop.Areas.User.Controllers
{
    public class ThanhToanController : Controller
    {
        ...
        public ActionResult StepEnd()
        {
            ...
            string newIDOrder = (Int32.Parse(db.DON_DAT_HANG.OrderByDescending(p => p.Ngaydat).FirstOrDefault().MaDH.Replace("DH", "")) + 1).ToString();
            newOrder.MaDH = "DH" + newIDOrder;
